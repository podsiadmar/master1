Feature: Example feature
    ...
    Background: Init Rest Assured
      ...
      Scenario: Send post to favourites
        When User defines request with body parameter 'image_id' and value '9ccXTANkb'
          And User defines request with body parameter 'sub_id' and value 'mojeKonto1'
          And User send POST request to Favourites endpoint to save image as favourite
        Then Response status should be 200